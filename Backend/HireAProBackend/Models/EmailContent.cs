...
<table style='border:none;border-spacing: 0; background-color: white; width: 90%; max-width:600px; text-align: center;height: 100%; max-height: 100%;'>
   <tr>
    <td style='background-color: #005573;'>
    </td>
   </tr>
   <tr>
    <td style='padding:40px 30px 0px 30px;text-align: center;color:#232d4b'><h1>¡Te damos la bienvenida"+user+@"!</h1></td>
   </tr>
    <tr>
        <td style='padding:0px 40px 40px 30px;text-align: center;color: #232d4b ;'> <h2>¡Gracias por unirte a la familia!</h2> 
           <span style='font-size: xxx-large;color: #f04641;'><b>—</b></span>
        </td>
        <tr>
    ...
    <tr>
        <td style='padding:40px 30px 0px 30px;text-align: center;'><h3>Síguenos en redes sociales</h3></td>
    </tr>
    <tr style='background-color:#005573 ;'>
        <td style='padding:20px 30px 30px 30px;text-align: center;' align='center'>
            <a class='button' href='' style='color: white; background-color: #b54845; padding: 6px; border-radius: 6px; text-decoration: none;font-weight: bold;'>Protección de datos</a>
            <br><br>
            <a class='button' href='' style='color: white; background-color: #b54845; padding: 6px; border-radius: 6px; text-decoration: none;font-weight: bold;'>Cancelar mi subscripción</a>
        </td>
    </tr>
    <tr>
        <td style='background-color: #232d4b;'><img src='imagenes/pie_oscuro.jpg' alt='Pie de página' width='100%'></td>
    </tr>
</table> 
</td>
</tr>
